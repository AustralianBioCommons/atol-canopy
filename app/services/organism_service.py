...
def build_project_metadata(*, organism_label: str, project_type: str) -> Dict[str, str]:
    if project_type == "root":
        return {
            ...
            "description": f"This project contains sequence data and asssemblies for the genome of {organism_label}. The sequencing data were generated by the [sample.bpa_initiative]. The {organism_label} sequencing sub-project was led by [experiment.data_owner], with collaborator/s [sample.project_collaborators]. The genome was assembled by the Australian Tree of Life Bioinformatics team. If you use these data, please cite the Initiative ([sample.bpa_initiative_citation]). Information on citation and attribution is provided in the Initiative's Data and Collaboration Policy ([sample.bpa_initiative_policy_DOI])."
        }
    if project_type == "genomic_data":
        return {
            "alias": f"Genomic data for {organism_label}",
            "title": f"{organism_label} - genomic data",
            "description": f"This project contains [sequence data and/or asssemblies] for the genome of {organism_label}. The sequencing data were generated by the [sample.bpa_initiative]. The {organism_label} sequencing sub-project was led by [experiment.data_owner], with collaborator/s [sample.project_collaborators]. The genome was assembled by the Australian Tree of Life Bioinformatics team. If you use these data, please cite the Initiative ([sample.bpa_initiative_citation]). Information on citation and attribution is provided in the Initiative's Data and Collaboration Policy ([sample.bpa_initiative_policy_DOI])."
        }
    return {}
