...
class OrganismService(BaseService[Organism, OrganismCreate, OrganismUpdate]):
    ...
    def create_organism(self, db: Session, *, organism_in: OrganismCreate) -> Organism:
        ...
        db.add(organism)
        try:
            root_project_metadata = build_project_metadata(
                organism_label=organism_label, project_type="root"
            )
            ...
            genomic_data_project_metadata = build_project_metadata(
                organism_label=organism_label, project_type="genomic_data"
            )
